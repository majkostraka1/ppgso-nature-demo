...
char *staticObjects::textureName[OBJ_COUNT] = {"tree.bmp", "bear.bmp", "bear.bmp", "yellow.bmp", "ground.bmp", "ground.bmp", "tree.bmp"};
char *staticObjects::meshName[OBJ_COUNT] = {"tree.obj", "bear.obj", "rat.obj", "sphere.obj", "cube.obj", "mountains.obj", "tree4.obj"};
...
staticObjects::staticObjects(glm::vec3 p, glm::vec3 r, glm::vec3 s, uint8_t id)
{
    ...
    if (!mesh[id])
        mesh[id] = std::make_unique<ppgso::Mesh>(meshName[id]);
