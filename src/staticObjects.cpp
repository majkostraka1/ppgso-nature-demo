...
char *staticObjects::textureName[OBJ_COUNT] = {"tree.bmp", "bear.bmp", "rat.bmp", "yellow.bmp", "ground.bmp"};
char *staticObjects::meshName[OBJ_COUNT] = {"tree.obj", "bear.obj", "rat.obj", "sphere.obj", "cube.obj"};
